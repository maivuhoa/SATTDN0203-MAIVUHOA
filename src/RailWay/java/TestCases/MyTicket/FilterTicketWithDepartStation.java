...
public class FilterTicketWithDepartStation extends BaseTest {
    private static final Logger logger = LogManager.getLogger(FilterTicketWithDepartStation.class);
    ...
    public void filterWithDepartStation() {
        ...
        String selecDepart = Utilities.randomNumber(0, 6);
        logger.info("Click My Ticket tab");
        myTicketPage.clickMyTicketTab();
        myTicketPage.selectDepartStation(selecDepart);
        myTicketPage.clickBtnFilter();
        Assert.assertEquals(myTicketPage.getTextDepartStation(), myTicketPage.getValueDepartStationinTable());
